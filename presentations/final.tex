...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \begin{axis}[mlineplot,width=\textwidth,height=8cm,xlabel=Level, ylabel={Mean Completion Time (minutes)}, xtick=data]
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \begin{axis}[mlineplot,width=\textwidth,height=8cm,xlabel=Level, ylabel={Number of Tries}, xtick=data]
...
\input{../report/subjective_table.tex}
\begin{center}
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \begin{axis}[mlineplot,height=6cm,width=\textwidth,xlabel=Level,
      ylabel={Number of Players}, xtick=data,ymin=0,ytick={0, 10, 20, 30, 40}]
